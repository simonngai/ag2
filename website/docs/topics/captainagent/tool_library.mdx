...
Building your own tool library is simple, follow the same directory layout as the one we provided. The python files should be named `root/{category}/{tool_name}.py`.
